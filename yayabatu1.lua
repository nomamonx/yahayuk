...
local BlacklistNames = {
    "YAHAVUKazigen","YAHAYUK","eugyne","Batu","HerulAjaDeh",
...
local function SendWebhook(title, description, extra)
    ...
    if not url or url == "" or tostring(url):find("PUT_YOUR_WEBHOOK") then
...
-- Save/Load wrapper (try multiple APIs)
local function SaveConfig()
    pcall(function()
        if Rayfield and Rayfield.SaveConfiguration then
            Rayfield:SaveConfiguration()
            return
        elseif Window and Window.SaveConfiguration then
...
local SummitLabel = CreateLabel(TabDetector, "Summit: 0")
...
local inputWebhookBox = CreateTextBox(TabSettings, { Name = "Webhook URL", PlaceholderText = Config.WebhookURL, Text = Config.WebhookURL or "", Callback = function(txt)
    Config.WebhookURL = txt or Config.WebhookURL
    SaveConfig()
end })

local toggleSendWebhookUI = CreateToggle(TabSettings, { Name = "Kirim Notif ke Discord", CurrentValue = Config.SendWebhook, Callback = function(v)
    Config.SendWebhook = v
    SaveConfig()
end })

local toggleWebhookEmbedUI = CreateToggle(TabSettings, { Name = "Gunakan Embed di Webhook", CurrentValue = Config.WebhookUseEmbed, Callback = function(v)
    Config.WebhookUseEmbed = v
    SaveConfig()
end })

-- fallback input (some rayfield versions use CreateInput)
local inputWebhook = TabSettings:CreateInput and TabSettings:CreateInput({
    ...
    Callback = function(Text)
        if Text and Text ~= "" then
            ...
            Notify("Webhook", "URL webhook disimpan.")
        else
...
local btnClearWebhook = TabSettings:CreateButton({
    ...
    Callback = function()
        Config.WebhookURL = nil
        if inputWebhookBox and inputWebhookBox.Set then pcall(function() inputWebhookBox:Set("") end) end
        if inputWebhook and inputWebhook.Set then pcall(function() inputWebhook:Set("") end) end
...
local inputScanInterval = CreateTextBox(TabSettings, { Name = "Scan Interval (detik)", PlaceholderText = tostring(Config.ScanInterval), Text = tostring(Config.ScanInterval), Callback = function(txt)
...
local toggleAutoHopUI = CreateToggle(TabSettings, { Name = "Auto Hop Jika Admin", CurrentValue = Config.AutoHop, Callback = function(v)
    Config.AutoHop = v
    SaveConfig()
end })
local toggleAutoLeaveUI = CreateToggle(TabSettings, { Name = "Auto Leave (kick) Jika Admin", CurrentValue = Config.AutoLeave, Callback = function(v)
    Config.AutoLeave = v
    SaveConfig()
end })
local toggleIgnoreFriendsUI = CreateToggle(TabSettings, { Name = "Ignore Friends", CurrentValue = Config.IgnoreFriends, Callback = function(v)
    Config.IgnoreFriends = v
    SaveConfig()
end })

-- Teleport points and UI (unchanged mostly)
local AutoTeleportDelay = 15
local TeleportCounter = 0
local TeleportLimitPerCycle = 20
local AutoTeleportPauseTime = 10
...
TeleTab:CreateButton({ Name = "🚩 Spawn", Callback = function() pcall(function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = teleportPoints.Spawn end) end })
TeleTab:CreateButton({ Name = "📍 Teleport CP 1", Callback = function() pcall(function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = teleportPoints.CP1 end) end })
TeleTab:CreateButton({ Name = "📍 Teleport CP 2", Callback = function() pcall(function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = teleportPoints.CP2 end) end })
TeleTab:CreateButton({ Name = "📍 Teleport CP 3", Callback = function() pcall(function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = teleportPoints.CP3 end) end })
TeleTab:CreateButton({ Name = "📍 Teleport CP 4", Callback = function() pcall(function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = teleportPoints.CP4 end) end })
TeleTab:CreateButton({ Name = "📍 Teleport CP 5", Callback = function() pcall(function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = teleportPoints.CP5 end) end })
TeleTab:CreateButton({ Name = "📍 Teleport CP 6", Callback = function() pcall(function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = teleportPoints.CP6 end) end })
TeleTab:CreateButton({ Name = "📍 Teleport CP 7", Callback = function() pcall(function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = teleportPoints.CP7 end) end })
TeleTab:CreateButton({ Name = "📍 Teleport CP 8", Callback = function() pcall(function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = teleportPoints.CP8 end) end })
TeleTab:CreateButton({ Name = "📍 Teleport CP 9", Callback = function() pcall(function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = teleportPoints.CP9 end) end })
TeleTab:CreateButton({ Name = "📍 Teleport CP 10", Callback = function() pcall(function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = teleportPoints.CP10 end) end })
TeleTab:CreateButton({ Name = "📍 Teleport CP 11", Callback = function() pcall(function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = teleportPoints.CP11 end) end })
TeleTab:CreateButton({ Name = "📍 Teleport Puncak", Callback = function() pcall(function() game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = teleportPoints.Puncak end) end })

-- Auto teleport toggle
local isAutoTeleporting = false
local autoTeleportTask = nil
local autoTeleportPoints = {
    teleportPoints.CP2, teleportPoints.CP3, teleportPoints.CP4, teleportPoints.CP5,
    teleportPoints.CP6, teleportPoints.CP7, teleportPoints.CP8, teleportPoints.CP9,
    teleportPoints.CP10, teleportPoints.CP11, teleportPoints.Puncak,
}

local function clickSummitRemote()
    local ok, result = pcall(function()
        local remote = game.ReplicatedStorage:FindFirstChild("GetExactSummitValue", true)
                ...
                while isAutoTeleporting do
                    for i, cf in ipairs(autoTeleportPoints) do
                        ...
                        if char and char:FindFirstChild("HumanoidRootPart") then
                            ...
                            Rayfield:Notify({ Title = "Auto Teleport", Content = "Teleport ke CP " .. i .. " | Count: " .. TeleportCounter, Duration = 2 })
                        end
                        task.wait(AutoTeleportDelay)
                        if TeleportCounter >= TeleportLimitPerCycle then
                            Rayfield:Notify({ Title = "Auto Teleport", Content = "Limit tercapai, pause " .. AutoTeleportPauseTime .. "s...", Duration = 3 })
                            task.wait(AutoTeleportPauseTime)
                            TeleportCounter = 0
                        end
                    end

                    Rayfield:Notify({ Title = "⛰️ Puncak", Content = "Mencoba klik tombol Summit...", Duration = 3 })
                    local clicked = clickSummitRemote()
                    if clicked then
                        Rayfield:Notify({ Title = "Summit", Content = "Tombol Summit berhasil ditekan!", Duration = 3 })
                    else
                        Rayfield:Notify({ Title = "Summit", Content = "Tombol Summit tidak ditemukan!", Duration = 3 })
                    end
                    ...
                    Rayfield:Notify({ Title = "Respawn", Content = "Respawn terdeteksi, lanjut auto teleport...", Duration = 3 })
                    task.wait(2)
                end
            end)
        else
            if autoTeleportTask then task.cancel(autoTeleportTask); autoTeleportTask = nil end
...
local function serverHopAttemptEnhanced() -- simplified, reuse your previous function if needed
...
local function performEscapeAction(playerName, reason)
    if Config.AutoHop then
        local ok = pcall(function() return serverHopAttemptEnhanced() end)
        if ok then
...
local function AutoHopServer()
    ...
    local player = game.Players.LocalPlayer
    Rayfield:Notify({ Title = "Auto Hop", Content = "Limit summit tercapai! Auto hop ke server baru...", Duration = 5 })
    local servers = {}
    local success, result = pcall(function()
        return game.HttpService:JSONDecode(game:HttpGet("https://games.roblox.com/v1/games/"..tostring(game.PlaceId).."/servers/Public?sortOrder=Asc&limit=100"))
    end)
    if success and result and result.data then
        for _,srv in ipairs(result.data) do
            if srv.playing < srv.maxPlayers then table.insert(servers, srv.id) end
        end
    end
    if #servers > 0 then
...
local function OnSummitReachedEnhanced()
    ...
    if Config.NotifyInGame then Notify("🏔️ Summit", "Summit tercapai! Total: " .. tostring(summitStats.count) .. " | Waktu terakhir: " .. FormatTimeSec(summitStats.lastTime)) end
...
TabSettings:CreateSlider({
    ...
    Callback = function(Value)
        ...
        Rayfield:Notify({ Title = "Auto Hop Updated", Content = "Limit summit diubah ke "..Value, Duration = 3 })
        SaveConfig()
    end
})
                ...
                summitStat:GetPropertyChangedSignal("Value"):Connect(function()
                    ...
                    if type(newVal) == "number" and newVal > lastVal then
                        ...
                        task.spawn(function()
                            ...
                            if confirmed then OnSummitReachedEnhanced() else Log("Summit naik tapi belum respawn → diabaikan.") end
                        end)
                    end
                    lastVal = newVal
                end)
    ...
    while true do
        ...
        if hrp then
            if hrp.Position.Y >= (Config.SummitPositionY or 1000) then
                if not aboveSince then aboveSince = tick() elseif tick() - aboveSince >= (Config.SummitPositionHold or 2) then
...
-- Load saved config (try multiple APIs)
LoadConfig()
...
-- ensure first-time save of defaults (so UI persists)
SaveConfig()
