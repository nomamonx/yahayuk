...
-- Pastikan variabel default ada
AutoTeleportDelay = AutoTeleportDelay or 2
PeakRespawnDelay = PeakRespawnDelay or 2
CP5WaitDelay = CP5WaitDelay or 5  -- default 5 detik
isAutoTeleporting = false
autoTeleportTask = nil

-- Section Teleport Otomatis
            ...
            autoTeleportTask = task.spawn(function()
                ...
                while isAutoTeleporting do
                    ...
                    for i, cf in ipairs(autoTeleportPoints) do
                        ...
                        -- delay CP1–CP4
                        if i == #autoTeleportPoints then
                            task.wait(CP5WaitDelay) -- delay khusus CP5 sebelum Puncak
                        else
...
-- Slider khusus CP5
TeleTab:CreateSlider({
    Name = "⏳ Delay di CP5 sebelum Puncak",
    Range = {0, 180},   -- bisa 0 detik sampai 3 menit
    Increment = 5,
    Suffix = "s",
    CurrentValue = CP5WaitDelay,
    Flag = "CP5Delay",
    Callback = function(Value)
        CP5WaitDelay = Value
    end,
