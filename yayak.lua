...
-- ========================
-- ========================
-- ESP Semua Player (Wallhack + Nama + Jarak)
-- ========================
...
local function CreateESP(player)
    ...
    ESPObjects[player] = {highlight, billboard, label}
end
...
-- Toggle ESP
SettingsTab:CreateToggle({
    Name = "ESP Semua Player (Wallhack + Nama + Jarak)",
    CurrentValue = false,
    Flag = "ESPWallhack",
    Callback = function(Value)
        ToggleESP(Value)
