...
-- Pastikan tetap aktif saat respawn
LocalPlayer.CharacterAdded:Connect(function(char)
    task.wait(0.5)
    SafeSetWalkSpeed(WalkSpeedSlider.CurrentValue)
    SafeSetJumpPower(JumpPowerSlider.CurrentValue)
    if InfJumpEnabled then
        EnableInfJump()
    end
end)
