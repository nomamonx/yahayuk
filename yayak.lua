...
local function CreateNameESP(player)
    ...
    billboard.Parent = game:GetService("CoreGui") -- biar global, bukan stuck di Head
    ...
    local function UpdateNow()
        ...
        and LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
            ...
            local display = player.DisplayName ~= "" and player.DisplayName or player.Name
            label.Text = display .. " [" .. math.floor(distance) .. "m]"
        else
...
-- ========================
-- Teleport ke Player (pakai DisplayName)
-- ========================
        ...
        if SelectedPlayer then
            ...
            if target and target.Character and target.Character:FindFirstChild("HumanoidRootPart") then
                ...
                if char and char:FindFirstChild("HumanoidRootPart") then
                    ...
                    Rayfield:Notify({
                        Title = "Teleport",
                        Content = "Berhasil teleport ke " .. target.DisplayName,
                        Duration = 5,
                    })
                end
            end
