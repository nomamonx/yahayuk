...
local Offset = Vector3.new(0, 5, 10) -- sedikit di atas & belakang target
local Smooth = 0.2
...
RunService.RenderStepped:Connect(function()
    if SpectateEnabled and SpectateTarget and SpectateTarget.Character and SpectateTarget.Character:FindFirstChild("HumanoidRootPart") then
        ...
        local desiredCFrame = CFrame.lookAt(root.Position + Offset, root.Position)
        Camera.CFrame = Camera.CFrame:Lerp(desiredCFrame, Smooth)
    end
end)
