...
-- Variabel delay default (auto teleport)
...
local teleportPoints = {
    ...
    Spawn = workspace:WaitForChild("SpawnLocation")
}
...
local autoTeleportPoints = {
    ...
    teleportPoints.CP19, teleportPoints.CP20, teleportPoints.CP21,
    teleportPoints.CP22, teleportPoints.Puncak
}
        ...
        if Value then
            autoTeleportTask = task.spawn(function()
                ...
                while isAutoTeleporting do
                    ...
                    local maxWait, waited = 6, 0
                    repeat
                        task.wait(0.5)
                        waited += 0.5
                        local char = player.Character
                        if char and char:FindFirstChild("HumanoidRootPart") then
                            if isAtSpawn(char.HumanoidRootPart.Position, 10) then break end
                        end
