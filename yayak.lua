...
-- WalkSpeed & JumpPower sekarang global
...
local WalkSpeedSlider = SettingsTab:CreateSlider({
    ...
    Callback = function(Value)
        ...
        SafeSetHumanoidProperty("WalkSpeed", WalkSpeedValue)
    end,
})
...
local JumpPowerSlider = SettingsTab:CreateSlider({
    ...
    Callback = function(Value)
        ...
        SafeSetHumanoidProperty("JumpPower", JumpPowerValue)
    end,
})
...
-- Pastikan Humanoid selalu update WalkSpeed & JumpPower
