...
-- ========================
-- Tambahan: Deteksi Admin + Summit > 100 (dengan label status)
-- ========================
...
-- Fungsi deteksi Summit tertinggi
local function DetectHighestSummit()
    local highestSummit = 100 -- threshold minimal
...
-- Label status (biar keliatan real-time)
