...
-- Fungsi auto climb semua checkpoint
local function AutoClimbCheckpoints()
...
-- Tambahkan ke tab Teleport sebagai button
TeleportTab:CreateButton({
    Name = "Auto Climb Checkpoints",
    Callback = function()
        task.spawn(AutoClimbCheckpoints)
        Rayfield:Notify({
            Title = "Auto Climb",
            Content = "Memulai teleport otomatis ke semua checkpoint!",
            Duration = 5,
        })
    end,
})
