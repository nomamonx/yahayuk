...
-- ========================
-- FunTab: Follow + Sit Player (duduk + goyang kencang)
-- ========================
local Players = game:GetService("Players")
...
local OffsetY = 1.5 -- posisi duduk tetap
local OscillationAmplitude = 1 -- goyang lebih kencang
local OscillationSpeed = 5 -- kecepatan goyang
        ...
        if FollowSitEnabled then
            ...
            FollowConnection = RunService.Heartbeat:Connect(function(dt)
                ...
                if TargetPlayer and TargetPlayer.Character and TargetPlayer.Character:FindFirstChild("HumanoidRootPart") then
                    local char = LocalPlayer.Character
                    if char and char:FindFirstChild("HumanoidRootPart") then
                        -- Posisi ngejar target + goyang kencang
