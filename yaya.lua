    ...
    Callback = function()
        if targetPlayer and targetPlayer.Character and targetPlayer.Character:FindFirstChild("Head") then
            ...
            if char and char:FindFirstChild("HumanoidRootPart") then
                ...
                -- Buat Weld
                sitWeld = Instance.new("Weld")
                sitWeld.Part0 = char.HumanoidRootPart
                sitWeld.Part1 = targetPlayer.Character.Head
                sitWeld.C0 = CFrame.new(0, 2, 0) -- offset 2 stud di atas kepala
                sitWeld.Parent = char.HumanoidRootPart

                -- Disable collisions sementara agar tidak nabrak
                ...
                Rayfield:Notify({
                    Title = "Fun",
                    Content = "Sekarang kamu duduk di kepala " .. targetPlayer.DisplayName,
                    Duration = 5,
                })
            end
        else
            Rayfield:Notify({
                Title = "Error",
                Content = "Target tidak valid atau tidak ada karakter!",
                Duration = 5,
            })
        end
    end,
...
FunTab:CreateButton({
    ...
    Callback = function()
        if sitWeld then
            ...
            Rayfield:Notify({
                Title = "Fun",
                Content = "Kamu sudah berhenti duduk di kepala pemain.",
                Duration = 5,
            })
        else
            Rayfield:Notify({
                Title = "Fun",
                Content = "Kamu tidak sedang duduk di kepala siapa pun.",
                Duration = 5,
            })
        end
    end,
