...
HWIDTab:CreateParagraph({
    Title = (isVIP and "✅ HWID Terdaftar" or "❌ HWID Tidak Terdaftar"),
    Content = "HWID kamu: "..hwid
})
HWIDTab:CreateButton({
    ...
    Callback = function()
        ...
        Rayfield:Notify({
            Title = "HWID",
            Content = "HWID disalin ke clipboard.",
            Duration = 4
        })
    end,
})
...
-- Variabel delay default (detik)
local AutoTeleportDelay = 2

-- Koordinat Teleport lengkap
local teleportPoints = {
    Spawn = CFrame.new(-46, 10, -5),
    ...
    CP10 = CFrame.new(1238, 2694, -2796),
    CP11 = CFrame.new(1619, 3058, -2760),
    CP12 = CFrame.new(1815,3578,-3249),
    CP13 = CFrame.new(2801, 4424, -4799),
    CP14 = CFrame.new(3471, 4858, -4186),
    CP15 = CFrame.new(3482, 5106, -4286),
    CP16 = CFrame.new(3981, 5666, -3977),
    CP17 = CFrame.new(4492, 5898, -3792),
    CP18 = CFrame.new(5065, 6370, -2983),
    CP19 = CFrame.new(5532, 6590, -2484),
    CP20 = CFrame.new(5548, 6874, -1041),
    CP21 = CFrame.new(4330, 7640, 126),
    CP22 = CFrame.new(3462, 7710, 942),
...
for i = 1,22 do
    TeleTab:CreateButton({
        ...
        Callback = function()
            local char = game.Players.LocalPlayer.Character
            if char and char:FindFirstChild("HumanoidRootPart") then
                char.HumanoidRootPart.CFrame = teleportPoints["CP"..i]
            end
        end
    })
end
...
-- Auto teleport CP1–CP22 + Puncak
local autoTeleportPoints = {}
for i = 1,22 do
    table.insert(autoTeleportPoints, teleportPoints["CP"..i])
end
table.insert(autoTeleportPoints, teleportPoints.Puncak)
            ...
            autoTeleportTask = task.spawn(function()
                while isAutoTeleporting do
                    for i, cf in ipairs(autoTeleportPoints) do
                        ...
                        task.wait(AutoTeleportDelay) -- pakai delay dari slider
                    end
