    ...
    Callback = function()
        if SelectedPlayer then
            ...
            if target and target.Character and target.Character:FindFirstChild("HumanoidRootPart") then
                ...
                bodyVelocity.Velocity = Vector3.new(0, 100, 0) -- atur kekuatan lemparan
                bodyVelocity.MaxForce = Vector3.new(0, math.huge, 0)
                bodyVelocity.P = 1000
                bodyVelocity.Parent = hrp

                -- Hilangkan BodyVelocity setelah 0.5 detik
                ...
                Rayfield:Notify({
                    Title = "Fun",
                    Content = "Player " .. SelectedPlayer .. " terlempar!",
                    Duration = 5,
                })
            end
        else
