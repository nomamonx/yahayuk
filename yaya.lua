...
local function CreateNameESP(player)
    ...
    distanceUpdate = RunService.RenderStepped:Connect(function()
        ...
        if char and char:FindFirstChild("HumanoidRootPart") and localChar and localChar:FindFirstChild("HumanoidRootPart") then
            local distance = (char.HumanoidRootPart.Position - localChar.HumanoidRootPart.Position).Magnitude
    ...
    ESPObjects[player] = {billboard = billboard, updateConnection = distanceUpdate, charAddedConnection = charAddedConn}
end
...
local function RemoveESP(player)
    if ESPObjects[player] then
        ...
        if ESPObjects[player].charAddedConnection then
            ESPObjects[player].charAddedConnection:Disconnect()
        end
...
local function ToggleESP(state)
    ...
    if ESPEnabled then
        ...
        for _, obj in pairs(ESPObjects) do
            ...
            if obj.charAddedConnection then obj.charAddedConnection:Disconnect() end
...
-- INFINITY JUMP
-- =========================
local InfinityJumpToggle = SettingsTab:CreateToggle({
    Name = "Infinity Jump",
    CurrentValue = false,
...
-- Tangani respawn agar toggle tetap aktif
LocalPlayer.CharacterAdded:Connect(function(char)
