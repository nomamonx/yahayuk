...
local function SitOnPlayer()
    ...
    ap.Attachment0 = Instance.new("Attachment", char.HumanoidRootPart)
    local ao = Instance.new("AlignOrientation")
    ao.Attachment0 = Instance.new("Attachment", char.HumanoidRootPart)

    -- Offset sedikit di atas kepala
    ap.Position = targetHRP.Position + Vector3.new(0, 3, 0)
