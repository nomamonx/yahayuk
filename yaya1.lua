...
-- ========================
-- FunTab: Follow + Sit Player (dengan offset)
-- ========================
local Players = game:GetService("Players")
...
-- ========================
-- Toggle Follow + Sit dengan Offset
-- ========================
local FollowSitEnabled = false
local OffsetY = 1 -- default tinggi di atas HumanoidRootPart target
        ...
        if FollowSitEnabled then
            ...
            FollowConnection = RunService.Heartbeat:Connect(function()
                if TargetPlayer and TargetPlayer.Character and TargetPlayer.Character:FindFirstChild("HumanoidRootPart") then
                    local char = LocalPlayer.Character
                    if char and char:FindFirstChild("HumanoidRootPart") then
                        char.HumanoidRootPart.CFrame = CFrame.new(TargetPlayer.Character.HumanoidRootPart.Position + Vector3.new(0, OffsetY, 0))
                    end
                end
            end)
        else
...
-- ========================
-- Toggle Pilih Offset Tinggi/Rendah
-- ========================
FunTab:CreateToggle({
    ...
    Callback = function(value)
        if value then
            OffsetY = 1 -- tinggi, di atas HumanoidRootPart target
        else
            OffsetY = -0.5 -- rendah, baring sedikit di bawah
        end
    end
})
