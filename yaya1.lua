...
FunTab:CreateButton({
    ...
    Callback = function()
        ...
        alignPos.Position = targetPlayer.Character.Head.Position + Vector3.new(0,2,0)
        alignPos.Parent = hrp

        -- Buat AlignOrientation
        ...
        attachObjects.updateLoop = task.spawn(function()
            while attachObjects.alignPos and attachObjects.target and attachObjects.target.Character and attachObjects.target.Character:FindFirstChild("Head") do
                attachObjects.alignPos.Position = attachObjects.target.Character.Head.Position + Vector3.new(0,2,0)
                task.wait(0.03)
            end
        end)
...
FunTab:CreateButton({
    ...
    Callback = function()
        ...
        if attachObjects.updateLoop then
            task.cancel(attachObjects.updateLoop)
